...
const char* Form::NotSignedException::what() const throw() {
    return "FormException: Not signed yet.";
}
...
void Form::SuccessExecute(const Bureaucrat& bc) const {
	std::cout << "Bureaucrat " << bc.getName() << " executed Form " << _name << "." << std::endl;
...
void Form::ErrorNotSignedYet(const Bureaucrat& bc) const {
	std::cout << " Bureaucrat " << bc.getName() << " could not execute Form " << _name
		<< " because it is not signed yet." << std::endl;
}
void Form::ErrorGradeTooLowToSign(const Bureaucrat& bc) const {
	std::cout << " Bureaucrat " << bc.getName() << " could not sign Form " << _name
		<< " because his/her grade is too low." << std::endl;
}
void Form::ErrorGradeTooLowToExecute(const Bureaucrat& bc) const {
	std::cout << " Bureaucrat " << bc.getName() << " could not execute Form " << _name
		<< " because his/her grade is too low." << std::endl;
}
